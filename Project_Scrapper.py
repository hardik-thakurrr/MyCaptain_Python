...
scraped_info_list = []
Project_connect.connect(args.dbname)
...
for page_num in range(1, page_num_MAX):
    ...
    for hotel in all_hotels:
        ...
        Project_connect.insert_into_table(args.dbname, tuple(hotel_dict.values()))

df = pd.DataFrame(scraped_info_list)
print(f"{'-'*5}Creating csv file{'-'*5}")
df.to_csv("Oyo.csv")
Project_connect.get_hotel_info(args.dbname)
